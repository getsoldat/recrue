...
class Publish extends Command
  ...
  parseOptions: (argv) ->
    ...
    options.usage """
      ...
      Usage: recrue publish [<newversion> | major | minor | patch | build]
             recrue publish --tag <tagname>
             recrue publish --rename <new-name>
      ...
      it is published to the recrue registry. The HEAD branch and the new tag are
